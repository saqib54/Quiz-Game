...
int main()
{
    ...
    q10.setValues("10. A subscipt is a(n) ____ .",
        "element in an array",
    ...
    q15.setValues("15. Most programmers use a for loop ____ .",
    ...
    q16.setValues("16. Adding 1 to a  variable is also called ____ it.",
        "digesting",
        "incrementing",
        "decrementing",
        "resetting",
    ...
    q18.setValues("18. A ____ is a variable that you set to indicate whether some event has occured.",
        "subscript",
        "banner",
        "counter",
        "flag",
